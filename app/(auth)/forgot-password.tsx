...
export default function ForgotPasswordScreen() {
  ...
  async function handleSend() {
    ...
    setError('');
    try {
      await api.post('/rider/auth/forgot-password', { email: email.trim() });
      router.push({ pathname: '/(auth)/forgot-password-otp', params: { email: email.trim() } });
    } catch (err: any) {
        ...
        >
          ...
          >
            ...
            <Text style={styles.hint}>
              Enter the email address linked to your rider account. We'll send you a 6-digit code to reset your password.
            </Text>
